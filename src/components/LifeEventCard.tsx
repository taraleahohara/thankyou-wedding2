...
const LifeEventCard = ({ event, isRectangle = false }: LifeEventCardProps) => {
  return (
    <div className={`group relative aspect-square ${isRectangle ? 'md:aspect-[2/1]' : ''} overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-brand/20`}>
