const FloralDecoration = ({ position = "top-right" }: { position?: "top-right" | "bottom-left" }) => {
  ...
  return (
    ...
    >
      ...
      <g stroke="currentColor" strokeWidth="1.5" className="text-brand">
        {/* Large flower */}
        ...
        <circle cx="100" cy="90" r="5" fill="currentColor" className="text-paper" />
        ...
        <circle cx="150" cy="115" r="3" fill="currentColor" className="text-paper" />
        
        {/* Small flower */}
        <path d="M170 140 Q168 137 166 140 Q164 143 168 145" />
        <path d="M170 140 Q172 137 174 140 Q176 143 172 145" />
        <circle cx="170" cy="142" r="2" fill="currentColor" className="text-paper" />
